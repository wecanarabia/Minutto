            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <a href="{{ route("front.reward-types.create") }}" class="btn btn-info float-end">
                        <i class="ti ti-device-desktop-plus text-white me-1 fs-5"></i> Add Bonus Type
                      </a>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Bonus Types</li>
                        </ol>
                    </nav>
                </div>
