          ...
          <div class="row align-items-center">
            <div class="col-12">
                ...
                <a href="{{ route('front.salaries.generate') }}" class="btn btn-info float-end mx-2">
                    <i class="ti ti-currency-real text-white me-1 fs-5"></i> @lang('views.SALARIES OF THIS MONTH')
                  </a>
                  @else
                  <a href="{{ route('front.salaries.update') }}" class="btn btn-info float-end mx-2">
                    <i class="ti ti-currency-dollar-singapore text-white me-1 fs-5"></i> @lang('views.UPDATE SALARIES OF THIS MONTH')
                  </a>
                  ...
                  <a href="{{ route("front.salaries.create") }}" class="btn btn-info float-end mx-2">
                    <i class="ti ti-currency-dollar-canadian text-white me-1 fs-5"></i> @lang('views.ADD SALARY OF NEW EMPLOYEE')
                  </a>
                  @endif
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">@lang('views.SALARIES')</li>
                </ol>
              </nav>
            </div>
        ...
        <div class="card card-body">
                <form class="position-relative" method="POST" action="{{ route("front.salaries.filter") }}">
                    ...
                    <select id="year-filter" name="year" class="form-select">
                        <option selected disabled>@lang('views.SELECT YEAR')</option>
                ...
                <div class="col-2">
                    ...
                    <select id="month-filter" name="month" class="form-select">
                        <option selected disabled>@lang('views.SELECT MONTH')</option>
                  ...
                  <div class="card border-0 zoom-in bg-light-primary shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-primary mb-1"> @lang('views.TOTAL ACTUAL SALARY') </p>
                  ...
                  <div class="card border-0 zoom-in bg-light-danger shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-warning mb-1">@lang('views.TOTAL DESUCTIONS AND ALERTS')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-warning shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL ADVANCES')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-info shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-danger mb-1">@lang('views.TOTAL ALLOWANCES')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-primary shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-success mb-1">@lang('views.TOTAL EXTRAS')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-success shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL BONUS')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-info shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL INSURANCE')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-warning shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL INCOME TAX')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-primary shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL RETIREMENT BENEFITS')</p>
                  ...
                  <div class="card border-0 zoom-in bg-light-success shadow-none">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <p class="fw-semibold fs-3 text-info mb-1">@lang('views.TOTAL NET SALARIES')</p>
