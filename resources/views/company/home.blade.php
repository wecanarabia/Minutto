          ...
          <div class="card border-0 zoom-in bg-light-primary shadow-none">
            <div class="card-body">
              <div class="text-center">
                ...
                <p class="fw-semibold fs-3 text-primary mb-1"> الموظفين </p>
                <h5 class="fw-semibold text-primary mb-0">12</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 zoom-in bg-light-warning shadow-none">
            <div class="card-body">
              <div class="text-center">
                ...
                <p class="fw-semibold fs-3 text-warning mb-1">ايام العمل</p>
                <h5 class="fw-semibold text-warning mb-0">26</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 zoom-in bg-light-info shadow-none">
            <div class="card-body">
              <div class="text-center">
                ...
                <p class="fw-semibold fs-3 text-info mb-1">الطلبات</p>
                <h5 class="fw-semibold text-info mb-0">9</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 zoom-in bg-light-danger shadow-none">
            <div class="card-body">
              <div class="text-center">
                ...
                <p class="fw-semibold fs-3 text-danger mb-1">الإجازات الرسمية</p>
          ...
          <div class="card border-0 zoom-in bg-light-success shadow-none">
            <div class="card-body">
              <div class="text-center">
                ...
                <p class="fw-semibold fs-3 text-success mb-1">الشروحات</p>
                <h5 class="fw-semibold text-success mb-0">102</h5>
              </div>
            </div>
          </div>
        </div>
