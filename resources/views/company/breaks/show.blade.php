                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a class="text-muted"
                                            href="{{ route('front.breaks.index') }}">@lang('views.BREAK REQUESTS')</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div id="cat-data" class="col-lg-12">
                                        ...
                                        <div class="chat-list chat active-chat" data-user-id="1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-7">
                                                    <p class="mb-1 fs-2">@lang('views.BREAK TIME')</p>
                                                ...
                                                <div class="col-6 mb-7">
                                                    <p class="mb-1 fs-2">@lang('views.BREAK DATE')</p>
                                                ...
                                                <div class="col-6 mb-7">
                                                    <p class="mb-1 fs-2">@lang('views.BREAK PERIOD')</p>
                                    ...
                                    <div id="cat-form" class="col-lg-12 d-flex align-items-stretch d-none">
                                        <div class="card w-100 position-relative overflow-hidden">
                                            <div class="card-body p-4">
                                                <h5 class="card-title fw-semibold">@lang('views.UPDATE BREAK REQUEST')</h5>
                                                <form method="post"
                                                    action="{{ route('front.breaks.update', $leave->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
