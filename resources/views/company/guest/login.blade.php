                ...
                <div class="col-sm-8 col-md-6 col-xl-9">
                  ...
                  <form method="post" action="{{ route("front.login") }}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                      <p class="fs-4 mb-0 fw-medium">@lang('views.NEW TO MINUTTO?')</p>
                      <a class="text-primary fw-medium ms-2" href="{{ route("front.register-page") }}">@lang('views.CREATE AN ACCOUNT')</a>
                    </div>
                  </form>
                </div>
              </div>
