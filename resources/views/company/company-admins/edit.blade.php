        ...
        <div class="col-lg-12">
            ...
            <div class="widget-content searchable-container list">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Edit Admin</h5>
                </div>
                <form method="post" action="{{ route('front.admins.edit', $admin->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $admin->name) }}" class="form-control"
                            id="exampleInputtext" placeholder="John Deo">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="phone" class="form-control"
                            value="{{ old('phone', $admin->phone) }}" id="exampleInputtext" placeholder="412 2150 451">
                        @error('phone')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="role_id">
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" @selected(old('role_id', $admin->role->id))>{{ $role->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('role_id')
