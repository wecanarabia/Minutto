        ...
        <div class="col-lg-12">
            ...
            <div class="widget-content searchable-container list">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">{{ $admin->name }}</h5>
                </div>
                <div class="chat-list chat active-chat" data-user-id="1">
                    <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                      <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset($admin->image) }}" alt="user4" width="72" height="72" class="rounded-circle">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <a href="{{ route("front.admins.edit",$admin->id) }}" class="btn btn-primary fs-2">Edit</a>
                    </div>
                  </div>
            </div>
        </div>
