                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">@lang('views.EDIT ROLE')</h5>
                                    </div>
                                    <form method="post" action="{{ route('front.roles.update', $role->id) }}">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="english_name"
                                                value="{{ old('english_name', $role->getTranslation('name', 'en')) }}"
                                                class="form-control">
                                            @error('english_name')
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="arabic_name"
                                                value="{{ old('arabic_name', $role->getTranslation('name', 'ar')) }}"
                                                class="form-control">
                                            @error('arabic_name')
                                                <div class="text-danger">
                                                    {{ $message }}
                                        ...
                                        <div class="mb-4">
                                            <label for="exampleInputPassword1"
                                                class="form-label fw-semibold">@lang('views.PERMISSIONS')</label>
                                            @foreach (config('global.permissions') as $name => $value)
                                                <div class="form-group col-sm-4">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class="chk-box" name="permissions[]"
                                                            @checked(in_array($name, $role->permissions)) value="{{ $name }}"
