                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a class="text-muted"
                                            href="{{ route('front.vacation-types.index') }}">@lang('views.VACATION TYPES')</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">@lang('views.EDIT VACATION TYPE')</h5>
                                    </div>
                                    <form method="post" action="{{ route('front.vacation-types.update',$type->id) }}">
                                        @csrf
                                        @method('PUT')
