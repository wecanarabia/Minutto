                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="row flex-wrap mb-3">
                                 ...
                                 <li class="row flex-wrap mb-3">
                                    ...
                                    <div class="col-8">
                                        <a href="{{ route('company.attendance.file',$attendance->id) }}" class="text-muted">{{ explode('/',$attendance->file)[2] }}</a>
                                    </div>
                                 </li>
                            </ul>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-6">
                                ...
                                <select class="form-select" id="exampleFormAtgtendanceStatus"
                                    ...
                                    <option value="{{ json_encode($status) }}" @selected($attendance->status==$status[Illuminate\Support\Facades\App::getLocale()])>
