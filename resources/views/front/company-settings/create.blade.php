<x-layouts.header title="Add Company Information"/>
<x-layouts.app>
         <!-- Body: Body -->
                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Add Company Information</h3>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Add Company Information</h6>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{ route('company.company-settings.store') }}">
                                    @csrf
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Allowed Leaves Count</label>
