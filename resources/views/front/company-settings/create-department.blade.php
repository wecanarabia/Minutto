           ...
           <div class="row align-item-center">
               <div class="col-md-12">
                   <div class="card mb-3">
                       ...
                       <div class="card-body">
                           <form method="post" action="{{ route('company.company-settings.department.store') }}">
                               @csrf
                               ...
                               <a href="{{ route('company.company-settings.shift.create') }}" class="btn btn-dark mt-4">Back</a>
