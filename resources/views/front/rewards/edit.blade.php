<x-layouts.header title="Edit Incentive"/>
<x-layouts.app>
         <!-- Body: Body -->
                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Edit Incentive</h3>
                            <div class="col-auto d-flex w-sm-100">
                                <a class="btn btn-dark btn-set-task w-sm-100" href="{{ route('company.rewards.index') }}"></i>Incentives</a>
                                <a class="btn btn-dark btn-set-task w-sm-100 mx-2 " href="{{ route('company.rewards.show',$reward->id) }}"></i>{{ $reward->user->name }} Incentive</a>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Edit Incentive</h6>
                            </div>
                            <div class="card-body">
