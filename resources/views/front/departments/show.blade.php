            ...
            <div class="col-md-12">
                <div class="card border-0 mb-4 no-bg">
                    <div class="card-header py-3 px-0 d-flex align-items-center  justify-content-between border-bottom">
                        <h3 class=" fw-bold flex-fill mb-0">Department Name</h3>
                    </div>
                </div>
            </div>
        </div><!-- Row End -->
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card teacher-card  mb-3">
                    <div class="card-header py-3 d-flex justify-content-between">
                        ...
                        <a  class="btn p-0" href="{{ route('company.departments.edit',$department->id) }}"><i class="icofont-edit text-primary fs-6"></i></a>
                    </div>
                    <div class="card-body  d-flex teacher-fulldeatil">
                        ...
                        <div class="profile-teacher pe-xl-4 pe-md-2 pe-sm-4 pe-0 text-center w220 mx-sm-0 mx-auto">
                            <a href={{ route('company.employees.show',$department->head->id) }}">
                                <img src="{{ asset($department->head->image) }}" alt="" class="avatar xl rounded-circle img-thumbnail shadow-sm">
                            </a>
                            <div class="about-info d-flex align-items-center mt-3 justify-content-center flex-column">
                                <h6 class="mb-0 fw-bold d-block fs-6">Head</h6>
                                <span class="text-muted small">{{ $department->head->name }}</span>
                            </div>
                        </div>
                        @else
                        ...
                        <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                            <ul class="list-unstyled mb-0">
                                <li class="row flex-wrap mb-3">
                                    ...
                                    <div class="col-8">
                                        <span class="text-muted">{{ $department->getTranslation('name', 'en') }}</span>
                                    </div>
                                </li>
                                <li class="row flex-wrap mb-3">
                                    <div class="col-4">
                                    ...
                                    <div class="col-8">
                                        <span class="text-muted">{{$department->getTranslation('name', 'ar')}}</span>
                                    </div>
                                 </li>
                                 <li class="row flex-wrap mb-3">
                                    <div class="col-4">
                                    ...
                                    <div class="col-8">
                                        <span class="text-muted">{{ $department->getTranslation('description', 'en') }}</span>
                                    </div>
                                 </li>
                                 <li class="row flex-wrap mb-3">
                                    <div class="col-4">
                                    ...
                                    <div class="col-8">
                                        <span class="text-muted">{{ $department->getTranslation('description', 'ar') }}</span>
                                    </div>
                                 </li>
                                 ...
                                 <li class="row flex-wrap mb-3">
                                    ...
                                    <div class="col-8">
                                        <span class="text-muted">{{ $department->employees()->count??"NO Employees added" }}</span>
                                    </div>
                                 </li>
                            </ul>
                        </div>
