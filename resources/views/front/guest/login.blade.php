...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 02:59:01 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-1 p-3 p-md-4" method="POST" action="{{ route('company.login') }}">
                               @csrf
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" name='remeber_me' for="flexCheckDefault">
                                            Remember me
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <input type="submit"  class="btn btn-lg btn-block btn-light lift text-uppercase" atl="signin" value="SIGN IN">
                                </div>
                                <div class="col-12 text-center mt-4">
...
<!-- Mirrored from pixelwibes.com/template/my-task/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 02:59:03 GMT -->
</html>
