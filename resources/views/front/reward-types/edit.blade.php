                            ...
                            <input type="hidden" name="id" value="{{ $reward->id }}">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="firstname" name="english_name" value="{{ old('english_name',$reward->getTranslation('name', 'en')) }}" required>
                                        @error('english_name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="arabic_name" value="{{ old('arabic_name',$reward->getTranslation('name', 'ar')) }}" id="lastname" required>
                                        @error('arabic_name')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
