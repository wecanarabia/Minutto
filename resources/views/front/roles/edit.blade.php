<x-layouts.header title="Edit Role"/>
<x-layouts.app>
         <!-- Body: Body -->
                ...
                <div class="row align-item-center">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('company.roles.update',$role->id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="firstname" name="english_name" value="{{ old('english_name',$role->getTranslation('name', 'en')) }}" required>
                                            @error('english_name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="arabic_name" value="{{ old('arabic_name',$role->getTranslation('name', 'ar')) }}" id="lastname" required>
                                            @error('arabic_name')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
