<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li>
                    <h5 class="bc-title">{{ __('Companies') }}</h5>
                </li>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="table-responsive active-projects manage-client">
                                        <div class="tbl-caption">
                                            <h4 class="heading mb-0"> {{ __('Companies') }}</h4>
                                        </div>
                                        <table class="table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @forelse ($data as $company)
                                                    <tr>
                                                        ...
                                                        <td><span>{{ $company->getTranslation('name', 'en') }}</span></td>
                                                        <td>
                                                            <span>{{ $company->getTranslation('name', 'ar')}}</span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class="text-secondary">{{ $company->subscription->name }}$</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-secondary">{{ $company->subscription_end_date }}$</span>
                                                        </td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.companies.show', $company->id) }}">Show</a>
                                                                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteModal"
                                                                    data-id="{{ $company->id }}" data-name="{{ $company->name }}">Delete</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
