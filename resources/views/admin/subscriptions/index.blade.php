<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            ...
            <a class="text-primary fs-13" href="{{ route('subscriptions.create') }}">+ Add Subscription</a>
        </div>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('subscriptions.edit', $subscription->id) }}">Edit</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('subscriptions.show', $subscription->id) }}">Show</a>
                                                                    {{-- <form method="POST"
