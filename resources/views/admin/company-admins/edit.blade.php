    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Company Admin') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Edit Company Admin') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Edit Company Admin') }}</h4>

                            <form method="POST" action="{{ route("admin.company-admins.update",$admin->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInputforth" name="phone" placeholder="phone" value="{{$admin->phone??old('phone') }}">
                                            @error('phone')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
