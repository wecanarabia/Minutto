<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li>
                    <h5 class="bc-title">{{ __('Company Admins') }}</h5>
                </li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Company Admins') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.company-admins.create') }}">+ Add Company Admin</a>
        </div>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="table-responsive active-projects manage-client">
                                        <div class="tbl-caption">
                                            <h4 class="heading mb-0"> {{ __('Company Admins') }}</h4>
                                        </div>
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.company-admins.edit', $admin->id) }}">Edit</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.company-admins.show', $admin->id) }}">Show</a>
